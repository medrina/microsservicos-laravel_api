...
<b>NOTA 3: </b>o bind-mount estará configurado e disponível para novas implementações de funções adicionais na estrutura da API. A pasta de todo o projeto poderá ser aberto pelo seu editor de código, uma vez que qualquer alteração que você realizar nos código-fontes, replicará nos fontes dos containers.<br>
...
Microsserviço <b>MSAVALIADOR:</b> http://localhost:8000/msavaliador/documentation<br>
Microsserviço <b>MSCLIENTES:</b> http://localhost:8000/msclientes/documentation<br>
Microsserviço <b>MSCARTOES:</b> http://localhost:8000/mscartoes/documentation<br>
...
Em primeiro lugar, deve-se cadastrar um usuário Administrador, acessando o microsserviço <b>MSAVALIADOR,</b> e o endpoint <b>register</b><br>
...
Para cadastrar um cartão de crédito/banco, você deve inserir o token de acesso obtido na sua autenticação do endpoint login do microsserviço <b>MSAVALIADOR</b> (<i>para saber mais como inserir o token no endpoint, consulte a seção <b>Swagger</b></i>).<br>
...
Acessar o microsserviço <b>MSCARTOES,</b> e o endpoint de <b>cadastrar um cartão</b><br>
...
___________________________________________________________________________
Para cadastrar um cliente, você deve inserir o token de acesso obtido na sua autenticação do endpoint login do microsserviço <b>MSAVALIADOR.</b> Acessar o microsserviço <b>MSCLIENTES,</b> e o endpoint de <i>cadastrar um cliente</i><br>
...
Acessar o microsserviço <b>MSAVALIADOR,</b> e o endpoint de <b>solicitar um cartão de crédto disponível ...</b><br>
